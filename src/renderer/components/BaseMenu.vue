            ...
            <template v-for="item in menuItems" :key="item.key || item.path">
                ...
                <div v-else class="menu-group" :class="{ 'menu-group-active': isActiveGroup(item) }">
                    ...
                    <transition name="submenu" appear>
                        <div v-if="!collapsed && (alwaysExpanded || expandedGroups.includes(item.key))"
                            class="menu-submenu">
                            <div v-for="subItem in item.children" :key="subItem.key || subItem.path"
                                class="menu-subitem" :class="{ 'menu-subitem-active': isActiveItem(subItem) }">
                    ...
                    <transition name="popup" appear>
                        <div v-if="collapsed && hoveredGroup === item.key" class="menu-popup"
                            @mouseleave="hoveredGroup = null">
                            <div class="menu-popup-title">{{ item.title }}</div>
                            <div v-for="subItem in item.children" :key="subItem.key || subItem.path"
                                class="menu-popup-item" :class="{ 'menu-popup-item-active': isActiveItem(subItem) }">
